...
catalog         :   CATALOG_ CATALOG_DATA_ {
                        gboolean succeeded = __mirage_parser_cue_set_mcn(self, $2, error);
...
file            :   TFILE_ STRING_ FILE_TYPE_ {
                        ...
                        succeeded = __mirage_parser_cue_set_new_file(self, $2, $3, error);
...
session         :   SESSION_ {
                        if (!__mirage_parser_cue_add_session(self, $1, error)) {
                            return -1;
                        }
                }
...
track_header    :   TRACK_ NUMBER_ TRACK_TYPE_ {
                        gboolean succeeded = __mirage_parser_cue_add_track(self, $2, $3, error);
...
track_index     :   INDEX_ NUMBER_ NUMBER_ {
                        if (!__mirage_parser_cue_add_index(self, $2, $3, error)) {
                            return -1;
                        }
                    }
...
track_flag_element  :   FOURCH_ {
                            if (!__mirage_parser_cue_set_flag(self, MIRAGE_TRACKF_FOURCHANNEL, error)) {
                                return -1;
                            }
                        }
                    |   DCP_ {
                            if (!__mirage_parser_cue_set_flag(self, MIRAGE_TRACKF_COPYPERMITTED, error)) {
                                return -1;
                            }
                        }
                    |   PRE_ {
                            if (!__mirage_parser_cue_set_flag(self, MIRAGE_TRACKF_PREEMPHASIS, error)) {
                                return -1;
                            }
                        }
                    |   SCMS_ {}
track_isrc      :   ISRC_ ISRC_DATA_ {
                        gboolean succeeded = __mirage_parser_cue_set_isrc(self, $2, error);
...
track_empty_part:   PREGAP_ NUMBER_ {
                        ...
                        if (!__mirage_parser_cue_add_pregap(self, $2, error)) {
                            return -1;
                        }
                    }
                |   POSTGAP_ NUMBER_ {
                        if (!__mirage_parser_cue_add_empty_part(self, $2, error)) {
                            return -1;
                        }
                    }
