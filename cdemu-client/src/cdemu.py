...
class CDEmu (object):
    ...
    def __load_device (self, device, filenames, params={}):
        ...
        try:
            ...
            if e.get_dbus_name() == MIRAGE_E_NEEDSPASSWORD:
                ...
                self.__print_error(_("Failed to load image: %s") % (e))
                return False
    ...
    def __cmd_load_device (self, arguments):
        ...
        if arguments[0] == "any":
            try:
                ...
                self.__print_error(_("Failed to get number of devices: %s") % (e))
                return False
            ...
            for device in range (0, nr_devices):
                ...
                try:
                    ...
                    self.__print_error(_("Failed to get status of device %i: %s") % (device, e))
                    continue
        ...
        if arguments[0] == "all":
            ...
            for device in range(0, nr_devices):
                try:
                    ...
                    self.__print_error(_("Failed to unload device %i: %s") % (device, e))
                    unload_fail = True
                    continue
            if unload_fail:
                return False
    ...
    def __cmd_device_mapping (self, arguments):
        ...
        for device in range (0, nr_devices):
            try:
                ...
                self.__print_error(_("Failed to get device mapping of device %i: %s") % (device, e))
                continue
            ...
            if arguments[0] == "all":
                ...
                for device in range(0, nr_devices):
                    try:
                        ...
                        self.__print_error(_("Failed to get daemon debug mask of device %i: %s") % (device, e))
                        continue
            ...
            if arguments[0] == "all":
                ...
                for device in range(0, nr_devices):
                    try:
                        ...
                        self.__print_error(_("Failed to set daemon debug mask of device %i to 0x%X: %s") % (device, dbg_mask, e))
                        continue
            else:
                device = string.atoi(arguments[0], 0)
            ...
            if arguments[0] == "all":
                ...
                for device in range(0, nr_devices):
                    try:
                        ...
                        self.__print_error(_("Failed to get library debug mask of device %i: %s") % (device, e))
                        continue
            ...
            if arguments[0] == "all":
                ...
                for device in range(0, nr_devices):
                    try:
                        ...
                        self.__print_error(_("Failed to set library debug mask of device %i to 0x%X: %s") % (device, dbg_mask, e))
                        continue
            else:
                device = string.atoi(arguments[0], 0)
            ...
            if arguments[0] == "all":
                ...
                for device in range(0, nr_devices):
                    try:
                        ...
                        self.__print_error(_("Failed to get DPM emulation flag of device %i: %s") % (device, e))
                        continue
            ...
            if arguments[0] == "all":
                ...
                for device in range(0, nr_devices):
                    try:
                        ...
                        self.__print_error(_("Failed to set DPM emulation flag of device %i to %i: %s") % (device, enabled, e))
                        continue
            else:
                device = string.atoi(arguments[0], 0)
            ...
            if arguments[0] == "all":
                ...
                for device in range(0, nr_devices):
                    try:
                        ...
                        self.__print_error(_("Failed to get transfer rate emulation flag of device %i: %s") % (device, e))
                        continue
            ...
            if arguments[0] == "all":
                ...
                for device in range(0, nr_devices):
                    try:
                        ...
                        self.__print_error(_("Failed to set transfer rate emulation flag of device %i to %i: %s") % (device, enabled, e))
                        continue
            else:
                device = string.atoi(arguments[0], 0)
            ...
            if arguments[0] == "all":
                ...
                for device in range(0, nr_devices):
                    try:
                        ...
                        self.__print_error(_("Failed to get device ID of device %i: %s") % (device, e))
                        continue
            ...
            if arguments[0] == "all":
                ...
                for device in range(0, nr_devices):
                    try:
                        ...
                        self.__print_error(_("Failed to set device ID of device %i to %s: %s") % (device, device_id, e))
                        continue
            else:
                device = string.atoi(arguments[0], 0)
    ...
    def __cmd_enum_supported_parsers (self, arguments):
        ...
        try:
            ...
            self.__print_error(_("Failed to enumerate supported parsers: %s") % (e))
            return False
    ...
    def __cmd_enum_supported_fragments (self, arguments):
        ...
        try:
            ...
            self.__print_error(_("Failed to enumerate supported fragments: %s") % (e))
            return False
    ...
    def __cmd_enum_daemon_debug_masks (self, arguments):
        ...
        try:
            ...
            self.__print_error(_("Failed to enumerate supported daemon debug masks: %s") % (e))
            return False
    ...
    def __cmd_enum_library_debug_masks (self, arguments):
        ...
        try:
            ...
            self.__print_error(_("Failed to enumerate supported library debug masks: %s") % (e))
            return False
    ...
    def __cmd_version (self, arguments):
        ...
        try:
            ...
            self.__print_error(_("Failed to get library version: %s") % (e))
            return False
        try:
            daemon_version = self.__dbus_iface.GetDaemonVersion()
        except dbus.DBusException, e:
            self.__print_error(_("Failed to get daemon version: %s") % (e))
            return False
    ...
    def __connect (self):
        try:
            ...
            self.__print_error(_("Failed to connect to CDEmu daemon: %s") % (e))
            return False
        ...
        try:
            ...
            self.__print_error(_("Failed to acquire daemon interface version (this most likely means your daemon is out-of-date): %s") % (e))
            return False
