...
#ifndef __IMAGE_ANALYZER_DISC_STRUCTURE_WINDOW_PRIVATE_H__
#define __IMAGE_ANALYZER_DISC_STRUCTURE_WINDOW_PRIVATE_H__
...
#endif /* __IMAGE_ANALYZER_DISC_STRUCTURE_WINDOW_PRIVATE_H__ */
