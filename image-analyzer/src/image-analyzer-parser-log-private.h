...
#ifndef __IMAGE_ANALYZER_PARSER_LOG_PRIVATE_H__
#define __IMAGE_ANALYZER_PARSER_LOG_PRIVATE_H__
...
struct _IMAGE_ANALYZER_ParserLogPrivate
{
    /* Text entry */
    GtkWidget *text_view;
};

#endif /* __IMAGE_ANALYZER_PARSER_LOG_PRIVATE_H__ */
